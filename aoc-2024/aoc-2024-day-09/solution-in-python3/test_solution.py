...
def test_to_block_representation_from(diskmap, expected):
    block_representation = solution.to_block_representation_from(diskmap)
    assert expected == block_representation


@pytest.mark.parametrize(
    "block_representation, expected",
    [
        #pytest.param('0..111....22222', '022111222......'),
        #pytest.param('00...111...2...333.44.5555.6666.777.888899', '0099811188827773336446555566..............'),
        pytest.param('0..111....22222', '022111222'),
        pytest.param('00...111...2...333.44.5555.6666.777.888899', '0099811188827773336446555566'),
    ],    
)
def test_to_compacted_from(block_representation, expected):
    compacted = solution.to_compacted_from(block_representation)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(input_full, "TODO"), # 89514618001 too low!
    ],    
)
