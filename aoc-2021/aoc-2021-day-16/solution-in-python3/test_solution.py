...
def test_next_literal_packet(hex_string, expected_version, expected_type_id, expected_literal_value_as_binary_string, expected_literal_value):
...
def test_operator_packets_using_binary(binary_string, expected_version, expected_type_id, expected_length_type_id, expected_sub_packet_literals):
    ...
    #assert len(packet_list) == 1 # Only 1 packet contained
