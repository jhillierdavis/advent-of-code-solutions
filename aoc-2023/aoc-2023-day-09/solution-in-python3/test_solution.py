...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param([1,0,-5,-10,-8,11,60,155,315,562,921,1420,2090,2965,4082,5481,7205,9300,11815,14802,18316], 22415), # last_value=18316 placeholders=[3514, 527, 55, 3]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param('puzzle-input-full.txt',1041), # < 1060
    ],    
)
